...
// Decoder converts Discord update DTOs into Otogi events.
...
// DefaultDecoder provides default Discord-to-otogi mappings.
...
// Decode converts a Discord update into an Otogi event.
...
func newBaseEvent(update Update) *platform.Event {
	...
	return &platform.Event{
		...
		Source: platform.EventSource{
			Platform: platform.PlatformDiscord,
		},
...
// decodeArticle maps Discord article payload into standardized article content.
...
// decodeEdit maps Discord edit payload into mutation semantics.
...
// decodeDelete maps Discord delete payload into retraction mutation semantics.
