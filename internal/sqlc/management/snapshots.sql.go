...
SELECT namespace, "key", module, updated_at, summary, payload_type, payload_json FROM snapshots
...
RETURNING namespace, "key", module, updated_at, summary, payload_type, payload_json
`
