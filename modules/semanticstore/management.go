...
func memoryTenantID(scope *ai.SemanticScope) string {
	if scope == nil {
		return ""
	}
...
func memoryPlatform(scope *ai.SemanticScope) string {
	if scope == nil {
		return ""
	}
...
func memoryConversationID(scope *ai.SemanticScope) string {
	if scope == nil {
		return ""
	}
